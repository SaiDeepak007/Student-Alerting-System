    ...
    <div class="form">
        <div class="container">
            <div class="signup-content">
                <div class="jumbotron ">
                    <h3 class="form-title">BACKLOGS DATA</h3>
                    <table class="table">
                    ...
                    $variable = substr($full, 0, strpos($full, "@"));
                               ...
                               $sql="SELECT * FROM `backlog` where rollno='$variable'";
                            
                               $result=mysqli_query($con,$sql);
                               if(mysqli_num_rows($result)>0){
                                while($row=mysqli_fetch_array($result)) {
                                    echo "<tr><th>".$row["rollno"]."</th><td>".$row["sem1"]."</td><td>".$row["sem2"]."</td><td>".$row["sem3"]."</td><td>".$row["sem4"]."</td><td>".$row["total"]."</td></tr>";
                                }
                               }
                               else
                               {
