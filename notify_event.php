...
<title>Student Alerting System | Notify Events</title>
...
if(mysqli_num_rows($res)>0){
   ...
   $subs=" <b>Event:</b> ".$row["name"]."<br> <b>Category:</b> ".$row["category"]." <br><b>Excepted Date:</b> ".$row["expected-date"]." <br> <b>Eligible Years:</b> ".$row["eligible"]." <br>PERCENTAGE: "."<br><br>";
    }
    }
    //Content
    $mail->isHTML(true);                        //Set email format to HTML
    $mail->Subject = 'Remainder from Student Alerting System';
    $mail->Body = "<p>Hey these are the details upcoming event conducted by our college</p> <br>".$subs;
