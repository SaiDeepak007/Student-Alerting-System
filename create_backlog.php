        ...
        <div class="container">
            <div class="signup-content">
                <div class="signup-form">
                    <h3 class="form-title">Update the Latest Backlog data here</h3>
                    <form method="POST" class="register-form" id="register-form">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="sem1" id="sem1"
                                placeholder="   Enter the No of backlogs in SEM1 " />
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="sem2" id="sem2"
                                placeholder="    Enter the No of backlogs in SEM2 " />
                        </div>
                        <div class="form-group">
                            <label for="sem3"><i class="zmdi "></i>Sem3: </label>
                            <br><br>
                            <input type="text" name="sem3" id="sem3"
                                placeholder="    Enter the No of backlogs in SEM3" />
                        </div>
                        <div class="form-group">
                            <label for="sem4"><i class="zmdi "></i>Sem4: </label>
                            <br><br>
                            <input type="text" name="sem4" id="sem4"
                                placeholder="    Enter the No of backlogs in SEM4" />
                        </div>
                        <div class="form-group">
                            <label for="total"><i class="zmdi "></i>total: </label>
                            <br><br>
                            <input type="text" name="total" id="total"
                                placeholder="   Enter the Total No of Backlogs " />
                        </div>
                        ...
                        <a type="button" class="btn btn-primary" href="view_result.php">View Backlog data</a>
                    </form>
                </div>
            </div>
...
if(isset($_POST['addresult'])){
    ...
    $sql="INSERT INTO `backlog`(`rollno`,`sem1`,`sem2`,`sem3`,`sem4`,`total`) VALUES('$dayselect','$s1','$s2','$s3','$s4','$s5')";
