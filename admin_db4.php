    ...
    <div class="form">
        ...
        <div class="signup-content">
                <div class="signup-form">
                    ...
                    <p>You can create/update and view Result Related data from here .</p>
                    <p>Use below buttons to navigate.</p>
                    <p style="color:blue; font-size:18px">->Results</p>
                    <br>
                    <a type="button" class="btn btn-primary notifybt" href="update_result.php">Update Result</a>
                    <br><br>
                    <a type="button" class="btn btn-primary notifybt" href="view_res.php">view Result Data</a>
                    <br><br>
