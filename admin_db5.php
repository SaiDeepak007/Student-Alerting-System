    ...
    <div class="form">
        ...
        <div class="signup-content">
                <div class="signup-form">
                    ...
                    <p>You can create/update and view Time-table Related data from here .</p>
                    <p>Use below buttons to navigate.</p>
                    
                    <p style="color:orange; font-size:18px">->Time-Table</p>
                    <br>
                    <a type="button" class="btn btn-primary , colour" href="createtimetable.php">Create/Update</a><br><br>
                    <a type="button" class="btn btn-primary , colour" href="viewtimetable.php">View Time-Table</a>
                    <br><br>
                    <a type="button" class="btn btn-primary notifybt , colour" href="notify.php">Notify All</a><br><br>
                </div>
